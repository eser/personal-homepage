                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 f-item">
                            <h2 class="sub-heading"><a href="https://larukedi.github.io/index.tr.html"><i class="fa fa-info margin-right-10px"></i>Özgeçmişim</a></h2>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 f-item">
                            <h2 class="sub-heading"><a href="https://eserozvataf.wordpress.com/"><i class="fa fa-pencil margin-right-10px"></i>Blog</a></h2>
                            <p class="xtext text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum, maiores sint possimus distinctio tenetur in magni animi pariatur sed.</p>
                        </div>
