    ...
    <section id="about" class="xanchor margined">
        <div class="container">
            <div id="about-general" class="row xanchor">
                <div class="col-xs-12">
                    <div class="xheader">
                        <h2><a href="#about-general" class="xscroll-link">General</a></h2>
                    </div>
                    ...
                    <div id="about-general-personal" class="xanchor">
                        <div class="row section-inner">
                            ...
                            <div class="col-xs-12 col-md-10">
                                <div class="row xrow">
                                    <div class="col-xs-12 col-sm-4 xlabel">Work Experience:</div>
                                    <div class="col-xs-12 col-sm-8 xvalue">12 Years (Since 2002)</div>
                                </div>
                                <div class="row xrow">
                                    <div class="col-xs-12 col-sm-4 xlabel">Birth Place/Year:</div>
                                    <div class="col-xs-12 col-sm-8 xvalue">İzmir, Turkey - 1984</div>
                                </div>
                                <div class="row xrow">
                                    <div class="col-xs-12 col-sm-4 xlabel">Military:</div>
                                    <div class="col-xs-12 col-sm-8 xvalue">Completed – TSK (January 2007 – April 2008)</div>
                                </div>
                                <div class="row xrow">
                                    <div class="col-xs-12 col-sm-4 xlabel">Languages:</div>
                                    <div class="col-xs-12 col-sm-8 xvalue">Turkish (Native), English (Advanced)</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="about-education" class="row xanchor">
                <div class="col-xs-12">
                    <div class="xheader">
                        <h2><a href="#about-education" class="xscroll-link">Education</a></h2>
                    </div>
                    ...
                    <div id="about-education-undergraduate" class="xanchor">
                        <div class="row section-inner">
                            ...
                            <div class="col-xs-12 col-md-10 xtext">
                                <h5 class="xtitle">EASTERN MEDITERRANEAN UNIVERSITY SCT INFORMATION TECHNOLOGY BSC (2010 – 2012)</h5>
                                CGPA: 3.12/4.00<br />
                                <br />

                                <h5 class="xtitle">CELAL BAYAR UNIVERSITY KMYO COMPUTER PROGRAMMING AS (2002 – 2004)</h5>
                                CGPA: 78.77/100
                            </div>
                        </div>
                    </div>
            ...
            <div id="about-workexperience" class="row xanchor">
                <div class="col-xs-12">
                    <div class="xheader">
                        <h2><a href="#about-workexperience" class="xscroll-link">Work Experience</a></h2>
                    </div>
                    ...
                    <div id="about-workexperience-fullstack" class="xanchor">
                        <div class="row section-inner">
                            ...
                            <div class="col-xs-12 col-md-10 xtext">
                                ...
                                <br />
                                <h5 class="xtitle">CMFNET (APRIL 2008 – FEBRUARY 2012) – PROJECT MANAGER – TEAM LEADER</h5>
                                Desktop Applications, Web Applications, Microsoft Office Add-ins, ActiveDirectory Tools, SMS Services and Protocols, Distributed Applications, 3. Party Tools for APIs
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="about-workexperience-senior" class="xanchor">
                        <div class="row section-inner">
                            ...
                            <div class="col-xs-12 col-md-10 xtext">
                                <h5 class="xtitle">DEVBIZ (AUGUST 2006 – JANUARY 2007) – SOFTWARE DESIGN ENGINEER</h5>
                                .NET Components, Continuous Integration Tools<br />
                                <br />
                                <h5 class="xtitle">ISPRO (NOVEMBER 2004 – AUGUST 2006) – APPLICATION DEVELOPER, SERVER ADMINISTRATOR</h5>
                                Linux Server Administration, Windows Server Administration, Mail Server Management, Desktop Applications, ActiveDirectory, Internet Service Provider Services
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="about-workexperience-medior" class="xanchor">
                        <div class="row section-inner">
                            ...
                            <div class="col-xs-12 col-md-10 xtext">
                                <h5 class="xtitle">EGEBILGI (JUNE 2004 – NOVEMBER 2004) – WEB DEVELOPER</h5>
            ...
            <div id="about-certificates" class="row xanchor">
                <div class="col-xs-12">
                    <div class="xheader">
                        <h2><a href="#about-certificates" class="xscroll-link">Certificates</a></h2>
                    </div>
                    ...
                    <div id="about-certificates-academic" class="xanchor">
                        <div class="row section-inner">
                            <div class="col-xs-12 col-md-2">
                                <h3 class="xtitle"><a href="#about-certificates-academic" class="xscroll-link">Academic</a></h3>
                            </div>
                            <div class="col-xs-12 col-md-10 xtext">
            ...
            <div id="about-interests" class="row xanchor">
                <div class="col-xs-12">
                    <div class="xheader">
                        <h2><a href="#about-interests" class="xscroll-link">Interests</a></h2>
                    </div>
                    ...
                    <div class="xheader">
                        <div class="row">
                            ...
                            <div id="p-filter" class="col-xs-8 text-right print-hidden">
                                ...
                                <a href="#projects" rel="others" class="btn btn-default btn-sm">Others</a>
                            </div>
                        </div>
                    </div>
