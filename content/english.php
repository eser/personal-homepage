                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#about-general" class="xscroll-link">General</a></li>
                                <li class="divider"></li>
                                <li class="dropdown-header">Background</li>
                                <li><a href="#about-education" class="xscroll-link">Education</a></li>
                                <li><a href="#about-workexperience" class="xscroll-link">Work Experience</a></li>
                                <li><a href="#about-certificates" class="xscroll-link">Certificates</a></li>
                                <li class="divider"></li>
                                <li><a href="#about-interests" class="xscroll-link">Interests</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#socialmedia-blogposts" class="xscroll-link">Blog Posts</a></li>
                                <li><a href="#socialmedia-tweets" class="xscroll-link">Latest Tweets</a></li>
                            </ul>
                        </li>
        ...
        <header id="splash">
            <div class="container">
                ...
                <div class="jumbotron custom-jumbotron">
                    <h1>Eser Özvataf</h1>
                    <p>I'm an IT consultant, a software architect and an ICT in Education MSc student who lives in Northern Cyprus. This page helps you to access the content I published on web by categorizing them.</p>
                    <p>
                        <a class="btn btn-lg btn-primary print-hidden" href="http://eserozvataf.wordpress.com/">Visit my blog &raquo;</a>
                        <a class="btn btn-lg btn-primary print-hidden" href="https://github.com/larukedi/">Github profile &raquo;</a>
                    </p>
                </div>
                                ...
                                <div class="row custom-section-inner">
                                    ...
                                    <div class="col-xs-10">
                                        ...
                                        <div class="row xrow">
                                            ...
                                            <div class="col-xs-8 xvalue">Turkish (Native), English (Upper Intermediate)</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div id="about-education-graduate" class="xanchor">
                                <div class="row custom-section-inner">
                                    ...
                                    <div class="col-xs-10 xtext">
                                        <h5>EASTERN MEDITERRANEAN UNIVERSITY FEDU INFORMATION AND COMMUNICATION TECHNOLOGY IN EDUCATION MSC (2013-)</h5>
                                        CGPA: -
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="about-education-undergraduate" class="xanchor">
                                <div class="row custom-section-inner">
                                    ...
                                    <div class="col-xs-10 xtext">
                                        <h5>EASTERN MEDITERRANEAN UNIVERSITY SCT INFORMATION TECHNOLOGY BSC (2010 – 2012)</h5>
                                        CGPA: 3.12/4.00<br />
                                        <br />

                                        <h5>CELAL BAYAR UNIVERSITY KMYO COMPUTER PROGRAMMING AS (2002 – 2004)</h5>
                                        CGPA: 78.77/100
                                    </div>
                                </div>
                            </div>
